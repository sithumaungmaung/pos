                        ...
                        <div class="well">
                           ...
                           @foreach($sale->items as $index => $item)
                              <tr id="cart-row-{{ $item->product_id }}">
                                 ...
                                 <td><i>Ks</i> {{ $item->sellingprice }}</td>
                                 {{-- <td>{{ $item->discount_type == 'percentage' ? $item->discount_amount . '%' : '<i>Ks</i> ' .$item->discount_amount }}</td>
                                  --}}
                                  <td>
                                    {{ $item->quantity }}
                                 ...
                                 <td><i>Ks</i> <span class="subtotal">{{ $item->total }}</span></td>
                                 <td>&nbsp;</td>
                              </tr>
                           @endforeach
                           ...
                           <tfoot>
                              <tr>
                                 ...
                                 <th colspan="2">
                                    <i>Ks</i> <span class="cart-total-display">{{ $sale->total + $sale->discount }}</span>
                              ...
                              <tr>
                                 ...
                                 <th colspan="2">
                                    <i>Ks</i> <span class="cart-discount-total-display">{{ $sale->discount }}</span>
                              ...
                              <tr>
                                 ...
                                 <th colspan="2">
                                    <i>Ks</i> <span class="cart-grandtotal-display">{{ $sale->total }}</span>
                             ...
                             {{--  <tr class="cart-balance-row">
                                 ...
                                 <th colspan="2">
                                    <i>Ks</i> <span class="cart-balance-display">{{ $sale->total - $sale->paid }}</span>
                                 </th>
                              </tr>
                              <tr>
                                 ...
                                 <th colspan="2">
                                    <div class="input-group">
                                       <span class="input-group-addon"><i>Ks</i></span>
...
<tr id="cart-row-{id}">
   ...
   <td><i>Ks</i> <span class="subtotal">{subTotal}</span></td>
   <td>
