                        ...
                        <div class="well">
                           ...
                           <tfoot>
                              <tr>
                                 ...
                                 <th colspan="2">
                                    <i class="fa">Ks</i> <span class="cart-total-display">0</span>
                              ...
                              <tr>
                                 ...
                                 <th colspan="2">
                                    <i class="fa">Ks</i> <span class="cart-discount-total-display">0</span>
                              ...
                              <tr>
                                 ...
                                 <th colspan="2">
                                    <i class="fa">Ks</i> <span class="cart-grandtotal-display">0</span>
                              ...
                              {{-- <tr class="cart-balance-row">
                                 ...
                                 <th colspan="2">
                                    <i class="fa">Ks</i> <span class="cart-balance-display">0</span>
                                 </th>
                              </tr> --}}
                              <tr>
                                 ...
                                 <th colspan="2">
                                    <i class="fa">Ks</i> <span class="cart-balance-paid">0</span>
                                    {{-- <div class="input-group">
                                       <span class="input-group-addon"><i class="fa">Ks</i></span>
...
<tr id="cart-row-{id}">
   ...
   <td>{productName}</td>
   <td>{productCode}</td>
   <td><i class="fa">Ks</i> {rate}</td>
   
   <td>
      <input name="cart[{id}][quantity]" onblur="calculate()" onchange="calculate()" step="1" type="number" min="1" max="{in_stock}" class="cart-row-quantity form-control input-sm" value="{quantity}"  />
   ...
   <td><i class="fa">Ks</i> <span class="subtotal">{subTotal}</span></td>
   <td>
   ...
   options = {
      ...
      onSearchComplete: function (query, suggestions) {
         ...
         if(suggestions.length == 1) {
            ...
            if (data.productcode.trim() == query.trim()) {
               addToCart(data);
            }
         }
      },
...
function addToCart (data) {
   ...
   if(row.size()) {
      ...
      var discount = '';
      var subTotal = data.sellingprice;
      ...
      if(data.discount_type == 'percentage') {
         ...
         discount = '<i class="fa">Ks</i> ' + data.discount;
      ...
      newRow = newRow.replace(/\{productCode\}/gi, data.productcode);
      newRow = newRow.replace(/\{rate\}/gi, data.sellingprice);
      newRow = newRow.replace(/\{cp\}/gi, data.buyingprice);
